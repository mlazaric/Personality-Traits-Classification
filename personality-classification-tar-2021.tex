...
In contrast, \cite{pizzolli} used a single model on \cite{pennebaker} dataset with subpar results, although they used the essay dataset only for the purpose of having a baseline, before moving on to predict traits of various characters in William Shakespeare's Hamlet.
