...
BERT requires fine tuning before it is ready for usage on other NLP tasks. For our use case we picked a promising personality trait [[NEED FURTHER EXPLANATION]], and fine-tuned a BERT\textsubscript{BASE}, cased variant of BERT which has 110 million parameters and is trained on cased dataset as opposed to uncased.
